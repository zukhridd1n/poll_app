...
from account.serializers import (AccountDetialSeriaizer, AccountSerializer,
                                 GroupSerializer, InterestSerializer,
...
class AccountView(ModelViewSet):
    ...
    @swagger_auto_schema(
        manual_parameters=[
            ...
            openapi.Parameter(
                "interest",
                openapi.IN_QUERY,
                description="User interest slug filter",
                type=openapi.TYPE_STRING,
            ),
            openapi.Parameter(
                "city",
                openapi.IN_QUERY,
                description="User`s city  filter",
                type=openapi.TYPE_STRING,
            ),
        ]
    )
    ...
    def update(self, request, pk=None):
        ...
        if request.user == account:
            ...
            return Response(
                data={"message": "You cannot update this account"},
